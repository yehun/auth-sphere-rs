...
/// Platform Passkey 控制器实现
struct PlatformPasskeyController;

impl PasskeyController for PlatformPasskeyController {
...
pub async fn register_begin(
    ...
    PlatformPasskeyController::passkey_register_begin(
        state,
        req.username.clone(),
    ).await
}
...
pub async fn register_complete(
    ...
    PlatformPasskeyController::passkey_register_complete(
        state,
        req.username.clone(),
...
pub async fn login_begin(
    ...
    PlatformPasskeyController::passkey_login_begin(
        state,
        req.username.clone(),
    ).await
}
...
pub async fn login_complete(
    ...
    PlatformPasskeyController::passkey_login_complete(
        state,
        request,
        req.username.clone(),
        req.credential.clone(),
...
pub async fn deactive(
    ...
    PlatformPasskeyController::passkey_deactivate(state, request).await
}
