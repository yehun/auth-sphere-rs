...
/// Member Passkey 控制器实现
struct MemberPasskeyController;

impl PasskeyController for MemberPasskeyController {
...
pub async fn register_begin(
    ...
    MemberPasskeyController::passkey_register_begin(
        state,
        req.username.clone(),
    ).await
}
...
pub async fn register_complete(
    ...
    MemberPasskeyController::passkey_register_complete(
        state,
        req.username.clone(),
...
pub async fn login_begin(
    ...
    MemberPasskeyController::passkey_login_begin(
        state,
        req.username.clone(),
    ).await
}
...
pub async fn login_complete(
    ...
    MemberPasskeyController::passkey_login_complete(
        state,
        request,
        req.username.clone(),
        req.credential.clone(),
...
pub async fn deactive(
    ...
    MemberPasskeyController::passkey_deactivate(state, request).await
}
